<template>
  <div class="min-h-svh flex items-center justify-center">
    <form @submit.prevent="submit" class="flex flex-col gap-2 w-96 p-8 rounded-xl border border-white bg-nord-lightest/10">
      ...
      <TextInput v-model="form.password_confirmation" :error="errors.password_confirmation" label="Confirm Password" type="password" key="confirm-password" color="light_transparent" />
